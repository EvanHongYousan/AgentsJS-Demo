...
- **Schema 错误？** → 查看 [常见错误文档](./docs/COMMON_ERRORS.md#1-schema-验证错误)
- **API Key 问题？** → 见下方第 1 节
- **OpenRouter 问题？** → 见下方第 0 节
- **工具不被调用？** → 见下方第 3 节
...
#### 问题: `Received tool input did not match expected schema`

**原因**: 工具的 schema 定义与 func 参数不匹配

**解决方案**: 
查看详细解决方案 → [常见错误文档 - Schema 验证错误](./docs/COMMON_ERRORS.md#1-schema-验证错误)

**快速修复**:
```javascript
// ❌ 错误：schema 有参数但 func 没接收
schema: z.object({
